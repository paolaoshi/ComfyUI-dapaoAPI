...
## 🪰全系更新为妙笔AI工坊，更专注丨所以更稳定
## 注册链接：https://api.dapaoai.com/sign-up?aff=vcOZ
### 步骤，1、进入钱包，购买兑换码，填入兑换码
###      2、申请API密钥，分组defult（默认的）
###      3、节点内填入API密钥即可

## 妙笔AI工坊并没有太多杂乱模型，暂时只有GPT-IMAGE-2/香蕉/seedance2.0/gpt系列等常用模型为AI助力，所以维护也会更加及时，以后再也不用担心中转站不稳定造成节点无法使用了！

## 现在大炮API会主要保留自己维护的妙笔AI工坊和RH稳定节点，后期其他渠道不再维护，望知悉


## 🎉26年6月11日大更新！新增RH全量模型，含全能图像全套，LLM对话全套，seedance2.0全套，V3.1全套！
## 价格透明，节点上直接显示价格，低价渠道也可以在节点内自由切换！
## 从下面地址注册账号，RH充值会员，在API界面，申请一个API密钥，RH会员可以选择钱多多版本，这样就是充多少有多少钱包余额
-------------------
## 🥗我的Runninghub主页【邀请码：kol01-rh138】【绑定送1000算力】🥗：👉[RH注册地址（一键直达）](https://www.runninghub.cn/user-center/1843821604546498561/userPost?inviteCode=kol01-rh138)👈
-------------------

![alt text](image-2.png)
## 🎿新增gpt和gemini修复，更换第三方供应商：👉[APIMart（一键直达）](https://apimart.ai/register?aff=Hu5VGF)👈
## 🦉新增优质image-2官方节点
## 新增即梦2.0真人模式
![alt text](image-1.png)
![alt text](0547924b160cc986a2533e6265343b0d.png)

### 🚀 2025-12-22 批量反推节点升级！
**新增 🍭大炮-API批量反推@炮老师的小课堂**
- 🌍 **中英文切换**：支持一键切换输出语言（中文/英文），内置全套英文 Prompt 优化。
- 📂 **文件夹批量**：支持直接读取文件夹内的所有图片进行反推。
- 🔌 **灵活输入**：保留 6 个图像输入接口，支持 Batch 和 List 混合输入。
- 💾 **自动保存**：反推结果自动保存为 TXT 文件，文件名与原图一一对应。
