...
from .gpt_image_2_node import (
    NODE_CLASS_MAPPINGS as GPT_IMAGE2_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GPT_IMAGE2_DISPLAY_MAPPINGS
)

# 加载 GPT Image 2 官方稳定节点
from .gpt_image_2_official_stable_node import (
    NODE_CLASS_MAPPINGS as GPT_IMAGE2_OFFICIAL_STABLE_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GPT_IMAGE2_OFFICIAL_STABLE_DISPLAY_MAPPINGS
)

# 加载 GPT Image 2 官方 4K 节点
from .gpt_image_2_official_4k_node import (
    NODE_CLASS_MAPPINGS as GPT_IMAGE2_OFFICIAL_4K_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GPT_IMAGE2_OFFICIAL_4K_DISPLAY_MAPPINGS
)

# 加载 GPT Image 2 综合节点
from .gpt_image_2_comprehensive_node import (
    NODE_CLASS_MAPPINGS as GPT_IMAGE2_COMPREHENSIVE_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GPT_IMAGE2_COMPREHENSIVE_DISPLAY_MAPPINGS
)

# 加载 GPT Image 2 官方账号出图节点
from .gpt_image_2_official_account_node import (
    NODE_CLASS_MAPPINGS as GPT_IMAGE2_OFFICIAL_ACCOUNT_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GPT_IMAGE2_OFFICIAL_ACCOUNT_DISPLAY_MAPPINGS
)

# 加载 APImart GPT Image 2 节点
from .gpt_image_2_apimart_node import (
    NODE_CLASS_MAPPINGS as GPT_IMAGE2_APIMART_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GPT_IMAGE2_APIMART_DISPLAY_MAPPINGS
)

# 加载 APImart Gemini 图像生成节点
from .gemini_image_apimart_node import (
    NODE_CLASS_MAPPINGS as GEMINI_IMAGE_APIMART_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GEMINI_IMAGE_APIMART_DISPLAY_MAPPINGS
)
...
from .gpt_smart_chat_node import (
    ...
    NODE_DISPLAY_NAME_MAPPINGS as GPT_SMART_CHAT_DISPLAY_MAPPINGS
)

# 加载 APImart 多模态智能对话节点
from .apimart_multimodal_chat_node import (
    NODE_CLASS_MAPPINGS as APIMART_MULTIMODAL_CHAT_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as APIMART_MULTIMODAL_CHAT_DISPLAY_MAPPINGS
)

# 加载 APImart 即梦 Seedance 2.0 节点
from .apimart_seedance2_node import (
    NODE_CLASS_MAPPINGS as APIMART_SEEDANCE2_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as APIMART_SEEDANCE2_DISPLAY_MAPPINGS
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **GPT_IMAGE2_OFFICIAL_ACCOUNT_MAPPINGS,
    **GPT_IMAGE2_APIMART_MAPPINGS,
    **GEMINI_IMAGE_APIMART_MAPPINGS,
...
# 整理节点菜单：保留主力维护分组、RH 功能专区和根目录节点，
# 其余节点统一收纳到“旧版节点(不再维护)”，并在注册顺序中移动到最末尾。
_DAPAO_CATEGORY_ROOT = "🤖dapaoAPI"
_DAPAO_CATEGORY_PREFIX = f"{_DAPAO_CATEGORY_ROOT}/"
_DAPAO_UNMAINTAINED_CATEGORY = f"{_DAPAO_CATEGORY_ROOT}/旧版节点(不再维护)"
_DAPAO_PRESERVED_GROUPS = {
    "🍬大炮AI主力维护🍬",
    "🦄RH功能专区🦄",
}
...
for _node_class in NODE_CLASS_MAPPINGS.values():
    ...
    if _category.startswith(_DAPAO_CATEGORY_PREFIX):
        ...
        if _top_level_group not in _DAPAO_PRESERVED_GROUPS:
            _node_class.CATEGORY = _DAPAO_UNMAINTAINED_CATEGORY

# ComfyUI按节点首次注册顺序建立分类菜单。将旧版节点整体后置，确保分组位于最下方。
_DAPAO_MAINTAINED_NODE_MAPPINGS = {
    _node_name: _node_class
    for _node_name, _node_class in NODE_CLASS_MAPPINGS.items()
    if _node_class.CATEGORY != _DAPAO_UNMAINTAINED_CATEGORY
}
_DAPAO_UNMAINTAINED_NODE_MAPPINGS = {
    _node_name: _node_class
    for _node_name, _node_class in NODE_CLASS_MAPPINGS.items()
    if _node_class.CATEGORY == _DAPAO_UNMAINTAINED_CATEGORY
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **GPT_IMAGE2_OFFICIAL_ACCOUNT_DISPLAY_MAPPINGS,
    **GPT_IMAGE2_APIMART_DISPLAY_MAPPINGS,
    **GEMINI_IMAGE_APIMART_DISPLAY_MAPPINGS,
...
print(f"  🙅 GPT Image 2：{len(GPT_IMAGE2_MAPPINGS)} 个")
