...
from .qwen_image_3_allround_node import (
    NODE_CLASS_MAPPINGS as QWEN_IMAGE_3_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as QWEN_IMAGE_3_DISPLAY_MAPPINGS,
)

from .gpt_image_25_allround_node import (
    NODE_CLASS_MAPPINGS as GPT_IMAGE_25_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as GPT_IMAGE_25_DISPLAY_MAPPINGS,
)
...
from .portrait_photography_prompt_node import (
    NODE_CLASS_MAPPINGS as PORTRAIT_PHOTOGRAPHY_PROMPT_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as PORTRAIT_PHOTOGRAPHY_PROMPT_DISPLAY_MAPPINGS,
)
...
from .seedance25_global_sp_video_node import (
    NODE_CLASS_MAPPINGS as SEEDANCE25_GLOBAL_SP_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as SEEDANCE25_GLOBAL_SP_DISPLAY_MAPPINGS,
)

from .seedance25_allround_video_node import (
    NODE_CLASS_MAPPINGS as SEEDANCE25_ALLROUND_VIDEO_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as SEEDANCE25_ALLROUND_VIDEO_DISPLAY_MAPPINGS,
)

from .wan30_official_allround_video_node import (
    NODE_CLASS_MAPPINGS as WAN30_OFFICIAL_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as WAN30_OFFICIAL_DISPLAY_MAPPINGS,
)

from .wan30_allround_video_node import (
    NODE_CLASS_MAPPINGS as WAN30_ALLROUND_VIDEO_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as WAN30_ALLROUND_VIDEO_DISPLAY_MAPPINGS,
)

from .short_drama_nodes import (
    NODE_CLASS_MAPPINGS as SHORT_DRAMA_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as SHORT_DRAMA_DISPLAY_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **GPT_IMAGE_25_MAPPINGS,
    **QWEN_IMAGE_3_MAPPINGS,
    ...
    **SEEDANCE25_ALLROUND_VIDEO_MAPPINGS,
    **SEEDANCE25_GLOBAL_SP_MAPPINGS,
    **WAN30_ALLROUND_VIDEO_MAPPINGS,
    **WAN30_OFFICIAL_MAPPINGS,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **GPT_IMAGE_25_DISPLAY_MAPPINGS,
    **QWEN_IMAGE_3_DISPLAY_MAPPINGS,
    ...
    **SEEDANCE25_ALLROUND_VIDEO_DISPLAY_MAPPINGS,
    **SEEDANCE25_GLOBAL_SP_DISPLAY_MAPPINGS,
    **WAN30_ALLROUND_VIDEO_DISPLAY_MAPPINGS,
    **WAN30_OFFICIAL_DISPLAY_MAPPINGS,
